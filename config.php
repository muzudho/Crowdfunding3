...
define('GOTEO_DB_SCHEMA'             , '--------');     // database name
define('GOTEO_DB_USERNAME'           , '--------');     // database user name
define('GOTEO_DB_PASSWORD'           , '--------');     // database password

// LocalGood Common Authentication Database
define('COMMON_AUTH_DB_SCHEMA'       , 'db_auth');      // database name

// Mail
define('GOTEO_MAIL_FROM'             , 'noreply@--------.com');
define('GOTEO_MAIL_NAME'             , 'Mr.--------');  // sasidasinin mei
define('GOTEO_MAIL_TYPE'             , 'smtp');         // mail, sendmail or smtp
define('GOTEO_MAIL_SMTP_AUTH'        , true);
define('GOTEO_MAIL_SMTP_SECURE'      , 'ssl');
define('GOTEO_MAIL_SMTP_HOST'        , 'serverNN.www.--------.com');   // ex.) sNN-coreserver-jp.value-domain.com
define('GOTEO_MAIL_SMTP_PORT'        , '465');
define('GOTEO_MAIL_SMTP_USERNAME'    , 'noreply@--------.com'); // username = mail address
define('GOTEO_MAIL_SMTP_PASSWORD'    , '--------');     // mail password

define('GOTEO_MAIL'                  , 'noreply@--------.com');
define('GOTEO_CONTACT_MAIL'          , 'contact@--------.com');
define('GOTEO_FAIL_MAIL'             , 'fail@--------.com');
define('GOTEO_LOG_MAIL'              , 'log@--------.com');
...
// Language
define('GOTEO_DEFAULT_LANG'          , 'ja');           // ex.) 'en'
...
// environment:
//  'local': Mail undeliverable. [CASH]button exists.
//  'beta' : Mail deliverable.   [CASH]button exists.
//  'real' : Mail deliverable.   [CASH]button no exists.
